                    ...
                    <div className="flex justify-center items-center space-x-5">
                        <form onSubmit={onSubmit}>   
                           <div className="relative bg-gray-200">
                              <input type="search" value={searchText} onChange={e => setSearchText(e.target.value)} id="default-search" className="block p-2  ps-10 text-md w-60 bg-gray-200 " placeholder="What are you looking for?"/>
                                <button onClick={()=>console.log(searchText)} className="absolute cursor-pointer inset-y-0 start-0 flex items-center content-center ps-3 ">
                                   <svg className="w-5 h-5 cursor-pointer transition-all text-gray-400 hover:text-gray-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                        ...
                        <div className="flex space-x-5">
                            ...
                            <svg onClick={()=> navigate('/cart')} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6 cursor-pointer">
